...
//TODO: declare REST_URL of server
                    ...
                    try {
                        ...
                        try (
                                java.sql.Connection conn = java.sql.DriverManager.getConnection(
                                    "jdbc:h2:C:/2526 Z/UTP_1w/classes/c10_/res/myDB"
                                );
    ...
    private void loadFromGrpc() {
        ...
        Thread.startVirtualThread(
            () -> {
                ...
                try {
//TODO: implement reading data from gRPC as it is specified in tutorial materials
